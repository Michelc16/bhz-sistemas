{'name': 'BHZ - Agenda Futebol (Cruzeiro, Atlético-MG, América-MG)',
 ...
 'assets': {'web.assets_frontend': ['bhz_football_agenda/static/src/scss/football_snippet.scss',
                                    'bhz_football_agenda/static/src/js/guiabh_football_matches.js'],
            'website.website_builder_assets': ['bhz_football_agenda/static/src/website_builder/**/*']},
 'application': True,
 'installable': True}
